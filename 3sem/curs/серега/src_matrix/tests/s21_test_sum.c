...
START_TEST(matrix_sum_test_2) {
  ...
  ck_assert_int_eq(my_sum_matrix(&A, &B, &result), ERROR_ARIFMETIK);
  my_remove_matrix(&A);
  my_remove_matrix(&B);
  my_remove_matrix(&result);
}
...
START_TEST(matrix_sum_test_5) {
  ...
  ck_assert_int_eq(my_sum_matrix(&A, &B, &result), ERROR);
  my_remove_matrix(&A);
  my_remove_matrix(&B);
  my_remove_matrix(&result);
}
...
START_TEST(matrix_sum_test_7) {
  ...
  ck_assert_int_eq(my_sum_matrix(&A, &B, NULL), ERROR);
  my_remove_matrix(&A);
  my_remove_matrix(&B);
  my_remove_matrix(&result);
}
...
START_TEST(matrix_sum_test_10) {
  ...
  ck_assert_int_eq(my_sum_matrix(&A, NULL, &result), ERROR);
  my_remove_matrix(&A);
  my_remove_matrix(&result);
}
END_TEST
